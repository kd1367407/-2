...
public:
	...
	//ワイプの進捗度と有効フラグ設定
	void SetWipeInfo(float progress, bool enable);
	...
	const cbMaterial& GetMaterialCB() const { return m_cb2_Material.Get(); }

	//外部からマテリアル情報を書き込むための関数
	void SetMaterialCB(const cbMaterial& material) { m_cb2_Material.Work() = material; m_cb2_Material.Write(); }
...
private:
	...
	KdConstantBuffer<cbWipe> m_cb3_Wipe;
