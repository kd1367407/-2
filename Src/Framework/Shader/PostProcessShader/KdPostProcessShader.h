...
public:
	...
	float GetBrightThreshold()const { return m_cb0_BrightInfo.Get().Threshold; }
...
private:
	...
	//ワイプ専用シェーダ
	ID3D11PixelShader* m_psWipe = nullptr;
	//定数バッファ
	KdConstantBuffer<KdStandardShader::cbWipe> m_cbWipe;
};
